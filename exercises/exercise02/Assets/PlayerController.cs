...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.W)) {
            lastRotation = new Vector3(lastRotation.x + Time.deltaTime * speed, lastRotation.y, lastRotation.z);
        }
        ...
        if (Input.GetKey(KeyCode.D)) {
            lastRotation = new Vector3(lastRotation.x, lastRotation.y + Time.deltaTime * speed, lastRotation.z);
        }
